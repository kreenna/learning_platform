...
class Course(models.Model):
    ...
    creator = models.ForeignKey(AUTH_USER_MODEL, on_delete=models.CASCADE, related_name="courses",
...
class Lesson(models.Model):
    ...
    creator = models.ForeignKey(AUTH_USER_MODEL, on_delete=models.CASCADE, related_name="lessons",
                                verbose_name="Создатель")
...
class Subscription(models.Model):
    owner = models.ForeignKey(AUTH_USER_MODEL, on_delete=models.CASCADE, related_name="subscriptions",
